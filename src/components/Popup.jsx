...
export default function Popup({ error }) {
  const { setShowPopup, dimensions } = useAppContext();
  return (
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    ...
    >
      <div className="container">
        <div
          className={`Popup-wrapper fixed top-0 left-0 z-[2000] bg-black/60 w-full h-screen flex justify-center ${
            dimensions.height > 520 ? "items-center" : "items-end pb-4"
          }`}
        >
